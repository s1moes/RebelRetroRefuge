...
<body>
    <div class="main">
            ...
            <a href="/RebelRetroRefuge/index.php"><img src="icon.jpg" alt="Logotipo" class="logotipo"></a>
            <ul class="primary-nav">
                ...
                <li class="nav-tab"><a href="contactos.php" <?php echo $scriptName == 'contactos.php' ? "class='corrente'" : '' ?>>Contactos</a></li>
            </ul>
